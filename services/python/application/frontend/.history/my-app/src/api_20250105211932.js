...
//w postmanie dla post i put wchodze w body form data i tam modyfikuje dlatego add i update rozni sie wzgledem aplikacji z springbootem znaczaco, nie moge wejsc do data gripa tak to dzia