...
export default App;
//zeby działało
//w gitbashu przejsccie do folderu z backedem tam,$ source venv/Scripts/activate jak nie dziala pip
//ogolnie to docker-compose build
//docker-compose up
//pamietac o axios i cors
//tutaj wejsc w gitbaashu do my-app i npm start
